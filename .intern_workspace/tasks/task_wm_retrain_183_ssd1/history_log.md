...
- 主管给 6 台机器清单(ssh -p 200XX zechuan@1.14.177.180)。逐台探测：
  - **.9(20009) 8×A100-64GB**：✅通，但**全被占**(各 free ~700MiB)，无空卡。
  - **.67(20067) 8×A100**：❌ Connection closed(经 .9 代理未通)。
  - **.134(20134) 5×A6000-48GB**：❌ Permission denied(无凭证)。
  - **.136(20136) 5×4090**：✅通，gpu4 整卡空(49GB)，余 ~17GB。→ 1 张空卡可用。
  - **.138(20138) 5×4090**：✅通，5 张各 free 26-29GB(半占)。
  - **.186(20186) 5×RTX Pro6000-96GB**：✅通，**5 张全空(各 97GB)**——但 **Pro6000=96GB 正是主管要排除的那台**。
- **矛盾点**：最理想的独占机(.186 全空 96GB)恰是被排除的；其他要么无空卡(.9)、要么连不上(.67/.134)、要么零星空卡(.136 一张)。需主管解此矛盾。
- 关键规格：本任务 update_actor 峰值 ~43GB。**.136 gpu4(49GB 整空)够跑但只 1 张(需 TP=2 需 2 张)；.9 A100-64GB 若能腾出 2 张最佳但现全占**。
- launch10(方案 B, .183 卡6,7)仍在跑。
